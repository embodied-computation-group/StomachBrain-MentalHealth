...
%cfgMain.TR=1.4;
%cfgMain.nVolumes=600;

%Filter 
cfgMain.saveFiltered = 0; %
cfgMain.filterType = 'fir2';
cfgMain.frequencySpread = 15; %in Hz divided by 1000 e.g. 15 = 0.015 Hz 
%% first & last 30 seconds cut (VMP TR=1.4secs so 21 vols cut)
cfgMain.beginCut = 21; % first and last 21 volumes from the total 600 are discarded systematically after bandpass filtering
cfgMain.endCut = 579; % 600 volumes - 21 volumes (cuts 30 seconds from end)
...
% Stats
cfgMain.numberofrandomizations = 10000; %1000 % number of randomizations of the clustering procedure (swtch labels empirical chance)
...
%cfgMain.alpha = 0.025; % exact one-sided p value that will be used for determine significance of clusters
