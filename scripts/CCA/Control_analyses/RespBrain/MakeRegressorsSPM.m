...
file = dir('/mnt/raid0/scratch/BIDS/derivatives/physio/resp/rest/RespRegressors/*.mat');
for n = 1 : length(file)
...
%         confounds = confounds(1:length(HFHRVregressor),:);
        ...
        save(sprintf('/mnt/raid0/scratch/BIDS/derivatives/physio/resp/rest/Respmotionacompcor_regressors/%s_regressors_Resp6motion6acompcor.mat', subID), 'R', 'names')
    else
