...
[EGG_raw,markers_raw] = prepro_egg_loadData(subj_idx,'REST',cfgMain.sample); % Only loads those channel with label 'EGG'
...
%     logEGGpreprocessing.powerinChosenChannel = maxPowerXChannel(bestChannel,1);
    ...
    load(strcat('D:\NAVIGASTRIC\stomachBrainNavigastric\files', filesep ,'sampleFieldtripStruc.mat'))
