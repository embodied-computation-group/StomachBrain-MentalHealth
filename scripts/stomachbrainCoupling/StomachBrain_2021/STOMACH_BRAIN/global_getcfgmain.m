...
cfgMain.beginCut = 21; % first and last 15 volumes from the total 450 are discarded systematically after bandpass filtering
cfgMain.endCut = 579;
...
cfgMain.numberofrandomizations = 1000; % number of randomizations of the clustering procedure (swtch labels empirical chance)
...
% Other
cfgMain.plotFigures= 0; % if 1 plots will be displayed if 0 they won't
